function checkWidthMobile() {
    ...
    if (window.innerWidth <= 900) {
        if (header || formChat || experienced_footer || experienced_body_left_center || feedback || tintuc || footer || health) {
            header?.remove();
            formChat?.remove();
        ...
        if (headerMobile || formChat_mobile || experienced_footer_mobile || experienced_body_left_center_mobile || tintuc_mobile || footer_mobile || health_mobile || banner_km_mobile || health_tintuc_mobile) {
        ...
        if (headerMobile || formChat_mobile || experienced_footer_mobile || experienced_body_left_center_mobile || tintuc_mobile || footer_mobile || health_mobile || health_tintuc_mobile) {
            headerMobile?.remove();
        ...
        if (header || formChat || experienced_footer || experienced_body_left_center || tintuc || footer || health) {
        ...
        if (window.innerWidth <= 900) {
            ...
            if (imgElements) {
                ...
                for (let i = 0; i < h2Elements?.length; i++) {
                    ...
                    h2Elements[i].style.background = 'url("https://dalieu.phongkhamdakhoanhatviet.vn/images/icons/icon_cong.webp") no-repeat left center';
                ...
                for (let i = 0; i < h3Element.length; i++) {
                    ...
                    h3Element[i].style.background = 'url("https://dalieu.phongkhamdakhoanhatviet.vn/images/icons/icon_mui.gif") no-repeat left center';
