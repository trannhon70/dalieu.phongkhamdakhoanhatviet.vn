...
$MenuDaLieu = $benhs->getDanhSachBenhByIdKhoa(2);
    ...
    <div id="header" class="container-fluid">
        ...
        <div style="background-color: #007156;">
            ...
            <div style="background-color: #007156;" class="container header_bottom">
                ...
                <div class="header_bottom_gt"> <a class="header_bottom_gt_a" target="_blank" href="https://dalieu.phongkhamdakhoanhatviet.vn/phong-kham-da-nhat-viet-phong-kham-da-khoa-uy-tin-tphcm-7.html">Giới thiệu</a></div>
                <div class="header_bottom_dm">

                    <a class="header_bottom_gt_a" href="#">bệnh da liễu</a>
                    <!-- <div class="dropdown_menu">
                        <div style="height: 10px;"></div>
                        <div class="dropdown_menu_body">
                            <ul class="dropdown_menu_body_ul">
                                <?php foreach ($MenuDaLieu as $value) : $activeClass = ($value['slug'] === $sessionBenh) ? 'active_menu_tab' : ''; ?>
